...
public class TakePost extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(embracer.equals("")||fromAddr.equals("")||toAddr.equals("")||reward.equals("")){
        	String json ="{\"success\":true,\"content\":\"取件任务发布失败！\"}";
    		...
    		String json ="{\"success\":true,\"content\":\"取件任务发布成功！\"}";
  	        Writer out = response.getWriter();
  	        out.write(json);
  	        out.flush();
  	        out.close();	
